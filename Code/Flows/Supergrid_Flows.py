...
def export_Xlinks_Flows(my_network):
    ...
    HVDC_out = pd.DataFrame(my_network.assets[8].flows.value[0:8760], columns = ['HVDC_out'])
    HVDC_in = pd.DataFrame(my_network.assets[8].flows.value[8760:17520], columns = ['HVDC_in'])
...
def export_XlinksEXT_Flows(my_network):
    ...
    HVDC0_out = pd.DataFrame(my_network.assets[12].flows.value[0:8760], columns = ['HVDC_out_0'])
    HVDC0_in = pd.DataFrame(my_network.assets[12].flows.value[8760:17520], columns = ['HVDC_in_0'])
    HVDC1_out = pd.DataFrame(my_network.assets[13].flows.value[0:8760], columns = ['HVDC_out_1'])
    HVDC1_in = pd.DataFrame(my_network.assets[13].flows.value[8760:17520], columns = ['HVDC_in_1'])
